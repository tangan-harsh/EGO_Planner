...
def generate_launch_description():
    ...
    use_raw_sensor_topic_arg = DeclareLaunchArgument('use_raw_sensor_topic', default_value=use_raw_sensor_topic, description='Use odom/cloud topics directly without drone_id prefix')
    ...
    # Ego Planner Node (prefixed sensor topics, simulation style)
    ego_planner_node_prefixed = Node(
        package='ego_planner',
        executable='ego_planner_node',
        name=['drone_', drone_id, '_ego_planner_node'],
        output='screen',
        condition=UnlessCondition(use_raw_sensor_topic),
        remappings=[
    ...
    # Ego Planner Node (raw sensor topics, real map style)
    ego_planner_node_raw = Node(
        package='ego_planner',
        executable='ego_planner_node',
        name=['drone_', drone_id, '_ego_planner_node'],
        output='screen',
        condition=IfCondition(use_raw_sensor_topic),
        remappings=[
    ...
    ld.add_action(use_raw_sensor_topic_arg)


    # Add Node
    ld.add_action(ego_planner_node_prefixed)
    ld.add_action(ego_planner_node_raw)
